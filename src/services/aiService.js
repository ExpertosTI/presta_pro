...
export const sendMessageToAI = async (chatHistory, userMessage, systemInstruction, apiKey) => {
    ...
    // Modelo Gemini Pro (estable, disponible en v1beta)
    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=${effectiveKey}`;
