...
export function Sidebar({ activeTab, setActiveTab, children, companyName, productName, hidePoweredBy }) {
  return (
    <aside className="flex flex-col w-64 bg-slate-950 text-slate-300 border-r border-slate-800/80 h-screen-safe md:h-full shadow-2xl z-50 safe-area-insets">
      <div className="p-6 flex items-center gap-3 border-b border-slate-800/50">
        ...
        <div>
          <h1 className="font-bold text-lg text-white tracking-tight leading-none">{productName || 'Presta Pro'}</h1>
      ...
      {!hidePoweredBy && (
        <div className="mt-auto pt-6 border-t border-slate-800/60 text-center pb-4 safe-area-bottom">
